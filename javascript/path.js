...
(function () {
  ...
  /**
   * Convert a windows path to an unix path. Ex: `C:\my\pa/th` ->
   * `/C:/my/pa\th`.
   *
   * @method dos2unix
  ...
  /**
   * Convert an unix path to a windows path. Ex: `/C:/my/pa\th` ->
   * `C:\my\pa/th`.
   *
   * @method dos2unix
   ...
   * paths still no absolute path is found, the root directory is used as well.
